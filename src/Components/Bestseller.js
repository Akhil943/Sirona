      ...
      <div id="carouselExamples" className=" container carousel slide pt-5">
            <div className="carousel-inner">
                <div className="carousel-item active">
                    <div className="row justify-content-evenly">
                        <div className=" col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/medium-menstrual-cup-listing-00.jpg" className="image-fluid w-100 py-2" alt="..." />
                        ...
                        <div className="col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/bum-cream-1_1.png" className="image-fluid w-100 py-2" alt="..." />
                            <div className="card-body text-center">
                        ...
                        <div className="col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/Exfoliating-Facewash_2.jpg" className="image-fluid w-100 py-2" alt="..." />
                            <div className="card-body text-center">
                        ...
                        <div className=" col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/Period-Stain-Remover-1.jpg" className="image-fluid w-100 py-2" alt="..." />
                            <div className="card-body text-center">
                ...
                <div className="row justify-content-evenly">
                        ...
                        <div className="col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/FSp577_1.png" className="image-fluid w-100 py-2" alt="..." />
                            <div className="card-body text-center">
                        ...
                        <div className="col-lg-3 card" style={{ width: "300px", }}>
                            <img src="https://files.thesirona.com/site-images/400x400/peebuddy-disposable-portable-female-urination-device-2_2.jpg " className="image-fluid w-100 py-2" alt="..." />
                            <div className="card-body text-center">
